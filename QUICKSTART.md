...
claudeloop --refactor                  # auto-refactor code after each phase (structural improvements)
...
- `--refactor` adds up to 2 more API calls per phase (refactoring + verification); up to 4 total with `--verify`
