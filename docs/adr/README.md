...
| [0033](0033-flight-recorder.md) | Flight recorder — self-contained HTML execution report | 2026-03-17 | Accepted |
| [0034](0034-fast-interrupt-shutdown.md) | Fast interrupt shutdown — background flight recorder | 2026-03-20 | Accepted |
